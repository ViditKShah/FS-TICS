...
export class DataService {
    ...
    getCandidates(searchCriteria: any): Observable<any> {
        ...
        return this.http.get("http://localhost:3000/getCandidates", { search: params }).map((res:any) => {
            return res.json();
        }).catch((error:any) => {
            return Observable.throw(error.json ? error.json().error : error || 'Server error')
        });
    ...
    getCandidateData(searchCriteria: any): Observable<any> {
        ...
        return this.http.get("http://localhost:3000/getCandidData", { search: params }).map((res:any) => {
            return res.json();
        }).catch((error:any) => {
            return Observable.throw(error.json ? error.json().error : error || 'Server error')
        });
    ...
    submitNewScore(score: Scores): Observable<any>{
        return this.http.post("http://localhost:3000/submitScore", score)
            .map((res:any) => {
                return res.json();
            })
            .catch((error:any) => {
    ...
    insertNewQuestion(ques:Questions): Observable<any>{
        return this.http.post("http://localhost:3000/insertQues", ques)
            .map((res:any) => {
                return res.json();
            })
            .catch((error:any) => {
    ...
    createNewTest(test:Test): Observable<any>{
        return this.http.post("http://localhost:3000/createTest", test)
            .map((res:any) => {
                return res.json();
            })
            .catch((error:any) => {
    ...
    submitAllAnswer(submit:Submissions): Observable<any>{
        return this.http.post("http://localhost:3000/submitAnswer", submit)
            .map((res:any) => {
                return res.json();
            })
            .catch((error:any) => {
    ...
    getTestDetails(searchCriteria:any, source: any) : Observable<Test[]>{
        ...
        return this.http.get("http://localhost:3000/getTests", { search: params })
                .map((res:any) => {
                    return res.json();
                })
                .catch((error:any) => {
    ...
    deleteQues(ques:Questions): Observable<any>{
        return this.http.post("http://localhost:3000/deleteQues", { id: ques._id })
        .map((res:any) => {
            return res.json();
        })
        .catch((error:any) => {
    ...
    deleteTest(test:Test): Observable<any>{
        return this.http.post("http://localhost:3000/deleteTest", { id: test._id })
        .map((res:any) => {
            return res.json();
        })
        .catch((error:any) => {
    ...
    getScores(searchCriteria: any): Observable<any> {
        ...
        return this.http.get("http://localhost:3000/getScores", { search: params }).map((res:any) => {
            return res.json();
        }).catch((error:any) => {
            return Observable.throw(error.json ? error.json().error : error || 'Server error')
        });
